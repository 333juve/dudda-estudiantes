  ...
  export default function Historial() {
    ...
    const initiateWhatsAppSMS = () => {
      ...
      Linking.openURL(url)
        ...
        .catch(() => {
          Alert.alert("Instala WhatsApp", "Asegúrate de tener WhatsApp instalado en tu dispositivo.");
        });
    };
            ...
            onPress={() => {
              if (!loading) {
                ...
                Alert.alert(
                  ...
                  "Mientras estamos arreglando la aplicación, por ahora puede programar una clase a través de WhatsApp.",
                  [
                    {
                      text: "Confirmar",
